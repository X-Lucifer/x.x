...
<html lang="zh-CN">
  <head>
    ...
    <style>
      :root { color-scheme: dark; font-family: system-ui, sans-serif; background: #050a11; color: #edf4f0; }
      body { min-height: 100vh; display: grid; place-items: center; margin: 0; }
      main { width: min(42rem, calc(100% - 3rem)); }
      small { color: #63f5d2; letter-spacing: .12em; }
      ...
      a { padding: .75rem 1rem; border: 1px solid #314038; color: #edf4f0; text-decoration: none; }
      a:first-child { background: #63f5d2; color: #07100b; }
    </style>
  </head>
  <body>
    <main>
